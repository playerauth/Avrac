      ...
      for (const proxyFn of PROXIES) {
        ...
        try {
          ...
          for (let i = 0; i < max; i++) {
            ...
            if (!article.img) article.img = source.customImage || "https://raw.githubusercontent.com/playerauth/Images/refs/heads/main/news.jpg";
      ...
      setTimeout(() => {
        if (itemsToShow.length > 0) {
          itemsToShow.forEach(article => {
            ...
            itemDiv.innerHTML = `
              <img src="${article.img}" alt="thumb" loading="lazy"
              ...
              <div>
                ...
                <p style="margin-top:6px; font-size:0.8rem; color:#0066cc; font-weight:600;">
                  Source: <a href="${source.sourceLink}" target="_blank" style="color:#0066cc;">${source.sourceName}</a>
                </p>
              </div>
            `;
          ...
          errorDiv.innerHTML = `
            <img src="https://raw.githubusercontent.com/playerauth/Images/refs/heads/main/private.jpg" style="opacity:0.8;">
            <div>
              ...
              <p style="margin-top:6px; font-size:0.75rem;">
                <a href="${source.sourceLink}" target="_blank" style="color:#0066cc;">Visit source →</a>
              </p>
            </div>
          `;
...
document.addEventListener("DOMContentLoaded", () => {
  if (typeof feeds !== "undefined") {
    ...
    const container = document.getElementById("feed-container");
    if (container) {
      container.innerHTML = '<div style="color:red; padding:40px; text-align:center;">Error: news.js missing</div>';
    }
  }
});
